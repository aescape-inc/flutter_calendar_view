...
class LiveTimeIndicator extends StatefulWidget {
  ...
  /// If true, there will be a circle on the left side of
  /// live time indicator
...
class _LiveTimeIndicatorState extends State<LiveTimeIndicator> {
  ...
  void initState() {
    ...
    _currentTime = TimeOfDay.fromDateTime(widget.getNow());
  ...
  void _onTick(Timer? timer) {
    final time = TimeOfDay.fromDateTime(widget.getNow());
